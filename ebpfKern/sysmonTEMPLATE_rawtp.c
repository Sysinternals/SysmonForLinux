...
#include "sysmonEVENT_NAME.c"

SEC("sysmon/EVENT_NAME/rawExit")
__attribute__((flatten))
int EVENT_NAMERawExit(struct bpf_our_raw_tracepoint_args *ctx)
{
    ...
    ptr = set_EVENT_NAME_info(eventHdr, config, pidTid, cpuId, eventArgs);
