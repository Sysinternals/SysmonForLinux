...
#include "sysmonFileDelete.c"

SEC("sysmon/FileDelete/rawExit")
__attribute__((flatten))
int FileDeleteRawExit(struct bpf_our_raw_tracepoint_args *ctx)
{
    ...
    ptr = set_FileDelete_info(eventHdr, config, pidTid, cpuId, eventArgs);
